  ...
  return (
    <main className="min-h-screen bg-black text-white flex flex-col items-center px-6 py-10">
      ...
      <div className="flex flex-col items-center text-center mb-10">
        <h1 className="text-4xl font-bold tracking-tight">AI job hunter</h1>
        <p className="mt-4 text-base text-[#ddd]">from your CV to your mock interview — AI helps you!</p>
      </div>
      ...
      <div className="w-full max-w-2xl mt-4">
        <InputMethodTabs
          ...
          onAppendText={(text) => setMessage((prev) => (prev ? `${prev} ${text}` : text))}
        />
      </div>
